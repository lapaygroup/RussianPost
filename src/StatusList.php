...
class StatusList
{
    ...
    private $statusMap = [
        ...
        '14' => [ // Таможенное оформление
            ...
            '17' => 'Отказ в выпуске. Ожидается уплата таможенных платежей',
            '18' => 'Отказ в выпуске по решению должностного лица',
            '19' => 'Требуется предъявление в ТО'
        ],
        ...
        '41' => [ // Обработка таможенных платежей
            '1' => 'Сумма платежа пересчитана ФТС',
